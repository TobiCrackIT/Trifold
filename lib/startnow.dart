    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Image.asset('assets/images/design.png',width: MediaQuery.of(context).size.width,),
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => StartNow())),
                child: Container(
                  ...
                  child: Center(
                    child: Text(
                      'Start Now',
                      style: TextStyle(color: Color(0xff4A154B), fontSize: 16),
                    ),
                  ),
                ),
              ),
